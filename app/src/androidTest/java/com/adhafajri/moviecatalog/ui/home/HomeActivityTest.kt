...
class HomeActivityTest {
    ...
    fun loadMovieCatalogs() {
        ...
        onView(withId(R.id.rv_movie)).perform(RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(dummyMovieCatalog.size))
    }
    ...
    fun loadShowCatalogs() {
        ...
        onView(withId(R.id.rv_show)).perform(RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(dummyShowCatalog.size))
    }
